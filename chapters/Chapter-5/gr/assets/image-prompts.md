...
- **Visual Description:** A 2D "Velocity Space" diagram.
  ...
  - **Vectors:** Show the Own Ship's current velocity vector pointing _inside_ the cone (red/dotted, indicating collision risk) and a "New Velocity" vector pointing _outside_ the cone (green/solid, indicating a safe maneuver).
