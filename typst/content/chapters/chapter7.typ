...
== Ασφάλεια Ναυτιλιακής Επιχειρησιακής Τεχνολογίας (OT)
...
== Μοντέλα Κυβερνοαπειλών Πλοίου-Ξηράς
...
#figure(
  image("../../assets/images/S7.2/001/image.png", width: 80%),
  caption: [Τοπίο Κυβερνοαπειλών Πλοίου-Προς-Ξηρά, που απεικονίζει κρίσιμα τρωτά σημεία σε δορυφορικές συνδέσεις επικοινωνίας (VSAT) και συστήματα εντοπισμού θέσης (GPS/AIS).],
) <fig-7-1>
...
== Αρχιτεκτονική Μηδενικής Εμπιστοσύνης (Zero Trust) για Ναυτιλιακά Συστήματα
...
== Προστασία Κρίσιμων Ναυτιλιακών Υποδομών
...
== Εφαρμογές Blockchain στις Ναυτιλιακές Εφοδιαστικές Αλυσίδες
