...
== Πλατφόρμες Ανάλυσης Ναυτιλιακών Μεγάλων Δεδομένων
...
#figure(
  image("../assets/images/S6.1/001/image.png", width: 80%),
  caption: [Αρχιτεκτονική Πολλαπλών Επιπέδων Πλατφόρμας Ανάλυσης Ναυτιλιακών Μεγάλων Δεδομένων - Ένα εννοιολογικό πλαίσιο που δείχνει τη μετάβαση από τη συλλογή ακατέργαστων δεδομένων στην εφαρμόσιμη επιχειρηματική ευφυΐα.]
) <fig-6-1>
...
== Μηχανική Μάθηση για Ναυτιλιακές Λειτουργίες
...
== Προγνωστική Ανάλυση στα Ναυτιλιακά Logistics
...
#figure(
  ...
  caption: [Επίδραση της Προγνωστικής Ανάλυσης στην Απόδοση των Ναυτιλιακών Logistics]
) <table-6-1>
...
== Βαθιά Μάθηση για Ωκεάνια Ανίχνευση
...
== Συστήματα Ανίχνευσης Ανωμαλιών στη Ναυτιλία
...
#figure(
  image("../assets/images/S6.6/001/image.png", width: 80%),
  caption: [Ροή Επεξεργασίας Edge AI και Σύντηξης Αισθητήρων - Απεικόνιση της επεξεργασίας πολυτροπικών δεδομένων αισθητήρων σε πραγματικό χρόνο στο "edge" του πλοίου για την επίτευξη αυτόνομης πλοήγησης και ανίχνευσης απειλών χωρίς εξάρτηση από το cloud.]
) <fig-6-2>
