= Βιωσιμότητα και Πράσινο Ναυτιλιακό Διαδίκτυο των Πραγμάτων (Green Maritime IoT)
...
== Συστήματα Συλλογής Ενέργειας και Πράσινο Υλικό

#figure(
  table(
    columns: (1.5fr, 1fr, 2fr, 2fr),
    inset: 8pt,
    align: horizon,
  ...
  caption: [Σύγκριση Πηγών Συλλογής Ενέργειας σε Θαλάσσια Περιβάλλοντα.],
) <table-8-1>
...
== Ενεργειακά Αποδοτικά Πρωτόκολλα και Δίκτυα
...
#figure(
  image("../../assets/images/S8.3/001/image.jpg", width: 80%),
  caption: [Βιο-εμπνευσμένες Στρατηγικές Ιχνηλάτησης Χημικών Πλουμίων. (α) Στρατηγική εμπνευσμένη από νυχτοπεταλούδες (Moth-inspired) με συμπεριφορές εφόρμησης (surge) και πλάγιας αναζήτησης (casting). (β) Στρατηγική εμπνευσμένη από αστακούς (Lobster-inspired) με χρήση στερεο-χημικής ανίχνευσης και ρεοταξίας.],
) <fig-8-1>
...
== Ψηφιακά Δίδυμα και Δυναμική Ανάλυση Βιωσιμότητας
...
== Blockchain και Αυτοματοποιημένη Ρυθμιστική Συμμόρφωση
...
#figure(
  image("../../assets/images/S8.5/001/image.png", width: 80%),
  caption: [Λογικό Διάγραμμα Ροής Έξυπνου Συμβολαίου για την Αυτοματοποιημένη Περιβαλλοντική Συμμόρφωση σε Περιοχές Ελέγχου Εκπομπών (ECAs).],
) <fig-8-2>
...
== Υποδομές Συνδεσιμότητας και Ασφάλειας
