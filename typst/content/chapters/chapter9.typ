...
== Ανάπτυξη Προτύπων για το Ναυτιλιακό IoT
...
#figure(
  table(
    ...
    [*UR E26 / E27*], [IACS], [#set text(hyphenate: true); Κυβερνοανθεκτικότητα], [Καθιστά υποχρεωτική την ασφαλή ενσωμάτωση συστημάτων (E26) και την ανθεκτικότητα του εξοπλισμού (E27).],
    [*Σειρά IEC 61162*], [IEC], [Ψηφιακές Διεπαφές], [Καθορίζει πρωτόκολλα (NMEA 0183/2000) for εξοπλισμό ναυσιπλοΐας και ραδιοεπικοινωνιών.],
...
== Σημασιολογική Διαλειτουργικότητα για Ναυτιλιακά Δεδομένα
...
#figure(
  image("../../assets/images/S9.2/001/image.jpg", width: 80%),
  caption: [Αρχιτεκτονική Σημασιολογικής Διαλειτουργικότητας - Απεικόνιση του μετασχηματισμού ετερογενών ναυτιλιακών δεδομένων σε έναν ενιαίο γράφο γνώσης με τη χρήση οντολογικής χαρτογράφησης.],
) <fig-9-1>
...
#figure(
  image("../../assets/images/S9.3/001/image.png", width: 80%),
  caption: [Στρατηγική Ενσωμάτωσης "Wrap-and-Extend" - Αναβάθμιση παλαιού ναυτιλιακού εξοπλισμού με πύλες IoT για την ενεργοποίηση της ψηφιακής παρακολούθησης χωρίς αντικατάσταση του βασικού εξοπλισμού.],
) <fig-9-2>
...
== Πρότυπα Ανταλλαγής Ναυτιλιακών Δεδομένων
...
- Η τυποποίηση είναι κρίσιμη για την ασφάλεια. Νέα πλαίσια, όπως το IACS UR E26/E27, έχουν επιβάλει την ανάγκη για κυβερνοανθεκτικότητα και διαλειτουργικότητα ως υποχρεωτικές απαιτήσεις ασφαλείας σε συνδεδεμένα πλοία, αντί να συνιστούν απλώς ορθές πρακτικές.
- Η Σημασιολογική Διαλειτουργικότητα Επιλύει την Ασάφεια. Δεν αφορά μόνο τη φυσική συνδεσιμότητα, αλλά και την ομοιόμορφη αναπαράσταση δεδομένων, και οι οντολογίες (όπως το SeaLiT, το ShipQuest) επιτρέπουν στα αυτοματοποιημένα συστήματα να λαμβάνουν αποφάσεις χωρίς παρεξηγήσεις δεδομένων.
