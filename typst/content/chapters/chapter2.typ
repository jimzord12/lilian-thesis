...
Στόχος είναι να καταδειχθεί πώς αυτά τα στοιχεία συνεργάζονται για την αντιμετώπιση των περιορισμών της αποστολής, συμπεριλαμβανομένης της αναξιόπιστης σύνδεσης, του παρατεταμένου χρόνου απόκρισης και των δύσκολων συνθηκών λειτουργίας. Η μελέτη θέτει επίσης ερωτήματα σχετικά με την ενορχήστρωση και την ευρωστία του συστήματος και την πλήρη απόδοση του συστήματος (Lin et al., 2010; Woźniak, 2018). Ο σχεδιασμός επιπέδου ελέγχου και η ενοποίηση υποδομής διαστήματος-εδάφους συζητούνται στις ενότητες 2.1-2.7, και οι ενότητες εξηγούν πώς να χρησιμοποιείται η διατεχνολογική παράδοση και διαχείριση φάσματος, η μεταφορά δεδομένων με ανοχή σφαλμάτων και η κατανεμημένη υπολογιστική, και η χρήση των δικτύων στα συστήματα ανίχνευσης και αυτονομίας, καθώς και στα συστήματα ασφαλείας που συζητούνται στα επόμενα κεφάλαια (Giordani & Zorzi, 2020; Xylouris et al., 2024).

Τα τμήματα αυτής της εργασίας είναι αλληλένδετα, καθώς συνδέουν τα ναυτιλιακά ζητήματα με πρόσφατες προσεγγίσεις και παραδείγματα περιπτώσεων χρήσης, και παρέχουν μια ενοποιημένη βάση δεδομένων που θα χρησιμοποιηθεί στο συμπέρασμα του κεφαλαίου καθώς και στη διατριβή που θα ακολουθήσει (Xylouris et al., 2024; Lin et al., 2010).
...
#figure(
  ...
  caption: [Αρχιτεκτονική τριών επιπέδων (Edge, Fog, Cloud) για το ναυτιλιακό περιβάλλον. Το διάγραμμα απεικονίζει τη ροή δεδομένων από τους αισθητήρες του πλοίου (Edge Layer), μέσω των κόμβων συγκέντρωσης δεδομένων σε λιμένες ή πλοία-ηγέτες (Fog Layer), προς την κεντρική υπολογιστική υποδομή (Cloud Layer) για προηγμένη ανάλυση και αποθήκευση.],
) <fig-2-2>
...
Τα μη επανδρωμένα πλοία και οι αισθητήρες στη θάλασσα δεν είναι εξοπλισμένοι με επαρκή ισχύ, επομένως, δεν μπορούν να αναπτυχθούν προηγμένα συστήματα επικοινωνία και υπολογιστών. Οι αναποτελεσματικοί διεθνείς ναυτιλιακοί νόμοι από πολλαπλές αρχές καθιστούν τα συστήματα μεταξύ πλοίων και τα συστήματα αυτά προβληματικά και η εγκατάστασή τους απαιτεί περισσότερο χρόνο. Δεν υπάρχει ομοιότητα στην ενσωμάτωση του IoT στη θάλασσα μεταξύ πλοίων και διεθνών αρχών.
