...
Στόχος είναι να καταδειχθεί πώς αυτά τα στοιχεία συνεργάζονται για την αντιμετώπιση των περιορισμών της αποστολής, συμπεριλαμβανομένης της αναξιόπιστης σύνδεσης, του παρατεταμένου χρόνου απόκρισης και των δύσκολων συνθηκών λειτουργίας. Η μελέτη θέτει επίσης ερωτήματα σχετικά με την ενορχήστρωση και την ευρωστία του συστήματος και την πλήρη απόδοση του συστήματος (π.χ., Lin et al., 2010; Woźniak, 2018). Ο σχεδιασμός επιπέδου ελέγχου και η ενοποίηση υποδομής διαστήματος-εδάφους συζητούνται στις ενότητες 2.1-2.7, και οι ενότητες εξηγούν πώς να χρησιμοποιείται η διατεχνολογική παράδοση και διαχείριση φάσματος, η μεταφορά δεδομένων με ανοχή σφαλμάτων και η κατανεμημένη υπολογιστική, και η χρήση των δικτύων στα συστήματα ανίχνευσης και αυτονομίας, καθώς και στα συστήματα ασφαλείας που συζητούνται στα επόμενα κεφάλαια (π.χ., Giordani & Zorzi, 2020; Xylouris et al., 2024).
