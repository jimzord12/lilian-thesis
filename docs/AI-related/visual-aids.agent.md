...
- **Visual Description:**
    - *Detail:* Prompt for a professional graphic designer or AI image generator.
    - *Components:* Specific nodes, layers, or devices.
    - *Flow:* Arrows, data paths, and relationships.
    - *Style:* Professional, schematic, high-contrast, academic colors.
