...
│   ├── images/
│   └── tables/
└── references/                # Prepared references organized by chapter(s)
    └── chapters-<id>/         # <id> reflects chapter scope (see naming below)
        └── prepared-references-<id>.md
```

### References Directory Naming Convention

The `<id>` in `chapters-<id>/` and `prepared-references-<id>.md` reflects the chapters included:

| Scope             | Example `<id>` | Path                                                         |
| ----------------- | -------------- | ------------------------------------------------------------ |
| Single chapter    | `3`            | `references/chapters-3/prepared-references-3.md`             |
| Range of chapters | `2-6`          | `references/chapters-2-6/prepared-references-2-6.md`         |
| List of chapters  | `1-3_4_7`      | `references/chapters-1-3_4_7/prepared-references-1-3_4_7.md` |
