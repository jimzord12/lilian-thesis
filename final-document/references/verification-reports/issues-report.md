...
### 1. ⚠️ final-document/references/chapters-1/prepared-references-1.md
- **Status:** suspicious
- **Confidence:** 🔴 low
- **Source:** crossref
- **Match Score:** 41.5%
- **Details:** Partial match found (Score: 41.5%).
- **Found Metadata:**
  - Title: References (All Chapters)
  - Year: 1992
  - Journal: Long-Range Planning of Japanese Corporations
- **Original Text:** `final-document/references/chapters-1/prepared-references-1.md`

### 2. ⚠️ final-document/references/chapters-2-10/prepared-references-2-10.md
...
- **Source:** crossref
- **Match Score:** 27.5%
- **Details:** Partial match found (Score: 27.5%).
- **Found Metadata:**
  - Title: References for Chapters 10, 11, 12, and 13.
  - Year: 2010
  - Journal: Ludwig's Applied Process Design for Chemical and Petrochemical Plants
- **Original Text:** `final-document/references/chapters-2-10/prepared-references-2-10.md
Generated: 28/12/2025
